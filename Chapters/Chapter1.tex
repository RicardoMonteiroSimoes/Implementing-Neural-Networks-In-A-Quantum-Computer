...
The corresponding equation, as shown by Weigold et al.\cite{Weigold2021_ExpandingDataEncodingPatterns}, is shown in equation \ref{equation:angle_embedding_two_hadamard_example}:
